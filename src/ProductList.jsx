...
function ProductList({ onHomeClick }) {
  ...
  const plantsArray = [
    ...
    },
    {
      ...
      plants: [
        ...
        { name: "Hyacinth", image: "https://cdn.pixabay.com/photo/2019/04/07/20/20/hyacinth-4110726_1280.jpg", description: "Beautiful flowering plant known for its fragrant.", cost: "$22" }
      ]
    },
    {
      ...
      plants: [
        ...
        { name: "Marigold", image: "https://cdn.pixabay.com/photo/2022/02/22/05/45/marigold-7028063_1280.jpg", description: "Natural insect repellent, adds color.", cost: "$8" },
        { name: "Geraniums", image: "https://cdn.pixabay.com/photo/2012/04/26/21/51/flowerpot-43270_1280.jpg", description: "Insect-repelling properties.", cost: "$20" },
    ...
    },
    {
      ...
      plants: [
        { name: "ZZ Plant", image: "https://images.unsplash.com/photo-1632207691143-643e2a9a9361?q=80&w=464&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", description: "Thrives in low light.", cost: "$25" },
        ...
        { name: "Cast Iron Plant", image: "https://cdn.pixabay.com/photo/2017/02/16/18/04/cast-iron-plant-2072008_1280.jpg", description: "Hardy plant, tolerates low light.", cost: "$20" }
      ]
    }
  ];

  // Navbar handlers
  const handleHomeClick = (e) => { e.preventDefault(); onHomeClick(); setShowPlants(false); setShowCart(false); };
  ...
  const handleContinueShopping = (e) => { e.preventDefault(); setShowCart(false); setShowPlants(true); };
  ...
  const styleObjUl = { display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '400px' };
    ...
    <div>
      ...
      <div className="navbar" style={styleObj}>
        <div className="luxury">
          ...
          <a href="/" onClick={handleHomeClick}><h3 style={{color:'white'}}>Paradise Nursery</h3><i style={{color:'white'}}>Where Green Meets Serenity</i></a>
        </div>
        <div style={styleObjUl}>
          <a href="#" onClick={handlePlantsClick} style={styleA}>Plants</a>
          <a href="#" onClick={handleCartClick} style={styleA} className="cart-icon">
            ...
            <span style={{marginLeft:'5px', color:'white', fontWeight:'bold'}}>{cart.length}</span>
          </a>
        </div>
      </div>
              ...
              <div className="plants-category-grid">
                {category.plants.map(plant => (
                  <div key={plant.name} className="plant-card">
                    ...
                    >
                      {cart.find(item => item.name === plant.name) ? "Added to Cart" : "Add to Cart"}
                    </button>
                  </div>
                ))}
              </div>
